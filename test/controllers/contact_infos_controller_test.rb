...
class ContactInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contact_info" do
    assert_difference('ContactInfo.count') do
      post contact_infos_url, params: { contact_info: { email: @contact_info.email, mobile_phone: @contact_info.mobile_phone, person_id: @contact_info.person_id, phone: @contact_info.phone } }
    end
  ...
  test "should update contact_info" do
    patch contact_info_url(@contact_info), params: { contact_info: { email: @contact_info.email, mobile_phone: @contact_info.mobile_phone, person_id: @contact_info.person_id, phone: @contact_info.phone } }
